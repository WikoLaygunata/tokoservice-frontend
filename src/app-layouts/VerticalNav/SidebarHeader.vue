	...
	<div class="sidebar-header flex items-center justify-between">
		<div class="logo-box grow" :class="{ mini: logoMini }">
			<Transition mode="out-in" name="fade">
				<Logo v-if="isDark && !logoMini" class="anim-wrap" :dark="true" :mini="false" />
				<Logo v-else-if="isLight && !logoMini" class="anim-wrap" :dark="false" :mini="false" />
				<Logo v-else-if="isDark && logoMini" class="anim-wrap" :dark="true" :mini="true" />
				<Logo v-else-if="isLight && logoMini" class="anim-wrap" :dark="false" :mini="true" />
			</Transition>
		</div>
		<Transition mode="out-in" name="fade">
			<div v-if="showPin && true" class="sidebar-pin flex items-center">

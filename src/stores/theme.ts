...
import { type PrimaryShade, exportPrimaryShades, exposure, getTypeValue, hex2rgb } from "@/utils/theme"
...
export const useThemeStore = defineStore("theme", {
	...
	persist: {
		paths: ["layout", "themeName", "routerTransition", "boxed", "sidebar", "footer", "colors"]
	}
})

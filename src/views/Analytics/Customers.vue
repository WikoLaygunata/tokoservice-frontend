...
const columns: DataTableColumns<any> = [{ title: "No", key: "idx", width: 50, align: "center", render: (_, index) => index + 1 }, { title: "Nama Pelanggan", key: "name", width: 200 }, { title: "No. WhatsApp / HP", key: "phone", width: 150 }, { title: "Alamat", key: "address", ellipsis: { tooltip: true }, width: 250 }, { title: "Total Unit Diservis", key: "total_tickets", align: "center", width: 150 }, { title: "Unit Selesai", key: "total_completed", align: "center", width: 120 }, { title: "Kunjungan Terakhir", key: "last_service_at", render: row => row.last_service_at ? dayjs(row.last_service_at).format("YYYY-MM-DD") : "-", width: 150 }]

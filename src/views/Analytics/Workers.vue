...
const columns: DataTableColumns<any> = [
	...
	{ title: "Nama Teknisi", key: "name", width: 200, render: row => h("div", [h("div", { class: "font-bold text-slate-800 dark:text-slate-100" }, row.name), row.phone ? h("div", { class: "text-xs text-slate-500" }, row.phone) : null]) },
	{ title: "Status", key: "is_active", align: "center", width: 100, render: row => h(NTag, { size: "small", type: row.is_active ? "success" : "default" }, { default: () => row.is_active ? "Aktif" : "Nonaktif" }) },
	{ title: "Ditugaskan", key: "total_assigned", align: "center", width: 120 }, { title: "Selesai", key: "total_completed", align: "center", width: 120 }, { title: "Batal", key: "total_cancelled", align: "center", width: 120 }, { title: "Sedang Dikerjakan", key: "total_in_progress", align: "center", width: 150 }, { title: "Success Rate", key: "success_rate", align: "center", width: 120, render: row => `${row.success_rate || 0}%` }, { title: "Rata-rata Waktu", key: "avg_duration_minutes", align: "center", width: 150, render: row => row.avg_duration_minutes > 0 ? `${row.avg_duration_minutes} mnt` : "-" }
]
